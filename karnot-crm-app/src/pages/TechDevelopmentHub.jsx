...
const PRODUCT_LINES = [
    ...
    },
    {
        ...
        description: 'Intelligent energy management system. Demand response (DR) deferral logic, load shifting, grid interaction, and energy analytics. Software + hardware IoT layer.',
        icon: Zap, color: 'green', bgGradient: 'from-green-500 to-emerald-600', status: 'active_development', timeline: '12 months',
        keySpecs: [
            { label: 'DR Deferral', value: 'Up to 4 hours', note: 'Thermal storage integration' },
            { label: 'Load Shifting', value: 'Peak to Off-peak', note: '30-50% cost reduction' },
            { label: 'Protocol', value: 'OpenADR 2.0b', note: 'Grid interoperability' },
            { label: 'IoT Platform', value: 'MQTT + REST API', note: 'Cloud dashboard' },
            { label: 'Metering', value: 'CT clamp + smart meter', note: 'Real-time kWh/kVA' },
            { label: 'AI/ML', value: 'Predictive load optimization', note: 'Weather + occupancy' },
        ],
        phases: [
            { phase: 'P1: DR Logic & Architecture', status: 'completed', duration: '2 months', tasks: ['DR deferral algorithm design', 'Thermal storage capacity modeling', 'OpenADR 2.0b integration spec', 'Edge controller hardware selection'] },
            { phase: 'P2: IoT Hardware', status: 'in_progress', duration: '3 months', tasks: ['Edge controller PCB design', 'CT clamp + metering integration', 'Communication module (4G/WiFi/LoRa)', 'Enclosure design (IP65)'] },
            { phase: 'P3: Cloud Platform', status: 'pending', duration: '3 months', tasks: ['Dashboard UI (React)', 'MQTT broker setup', 'REST API for DR signals', 'Historical data + analytics'] },
            { phase: 'P4: ML/AI Layer', status: 'pending', duration: '2 months', tasks: ['Load prediction model', 'Weather API integration', 'Occupancy pattern learning', 'Optimal start/stop logic'] },
            { phase: 'P5: Pilot & Certify', status: 'pending', duration: '2 months', tasks: ['Pilot site installation (3 sites)', 'Performance verification', 'Grid operator coordination', 'Product certification'] },
        ],
        challenges: [
            { challenge: 'DR deferral without comfort compromise (temperature drift limits)', priority: 'CRITICAL', status: 'active' },
            { challenge: 'Reliable edge-to-cloud communication in PH infrastructure', priority: 'HIGH', status: 'active' },
            { challenge: 'ML model accuracy with limited training data', priority: 'MEDIUM', status: 'research' },
            { challenge: 'Integration with multiple HVAC OEM protocols', priority: 'MEDIUM', status: 'pending' },
        ],
    },
];
